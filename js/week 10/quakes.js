import { getJSON } from './quakesUtility.js';
// Quake Model
export default class Quake {
    ...
    async getEarthQuakesByRadius(position, radius = 100) {
        ...
        const _newUrl = this.baseUrl + "&latitude=" + position.lat + '&longitude=' + position.lon + "&maxradiuskm=" + radius;
        console.log(_newUrl);
        this._quakes = await getJSON(_newUrl);
        return this._quakes;
    }
    getQuakeById(id) {
